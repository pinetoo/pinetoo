...
EGIT_COMMIT="c90e0914bee3d2e8f3620cc62aa46be0ca40f395"

KERNEL_TAG="5.16-20220216-2000"
...
PATCHES=(
	"${WORKDIR}/${P}/5.16.10-11.patch"
	"${WORKDIR}/${P}/5.16.11-12.patch"
	"${WORKDIR}/${P}/5.16.12-13.patch"
	"${WORKDIR}/${P}/5.16.13-14.patch"
	...
	"${WORKDIR}/${P}/0103-media-ov5640-Implement-autofocus.patch"
	"${WORKDIR}/${P}/0104-ccu-sun50i-a64-reparent-clocks-to-lower-speed-oscillator.patch"
	"${WORKDIR}/${P}/0105-quirk-kernel-org-bug-210681-firmware_rome_error.patch"
	"${WORKDIR}/${P}/0106-leds-gpio-make-max_brightness-configurable.patch"
	"${WORKDIR}/${P}/0107-panic-led.patch"
