...
EGIT_COMMIT="c3b23c674794e97280bc7172f57b058a58dfdca8"
...
SRC_URI="https://github.com/TrustedFirmware-A/trusted-firmware-a/archive/refs/tags/v${TFVER}.tar.gz -> trusted-firmware-a-${TFVER}.gh.tar.gz"
S=${WORKDIR}
...
src_compile() {
	...
	emake PLAT=sun50i_a64 bl31 SUNXI_PBOOT=1 SUNXI_SETUP_REGULATORS=1 SUNXI_AMEND_DTB=1 LOG_LEVEL=$(usex debug LOG_LEVEL_NOTICE LOG_LEVEL_ERROR) CROSS_COMPILE="${CHOST}-"
